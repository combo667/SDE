...
public:
    ...
    Node *OptimalApproach2(LinkedList);
};
...
Node *LinkedList::OptimalApproach2(LinkedList list2)
{
    ...
    while (x != y)
    {
        ...
        x = x == NULL ? list2.head : x->next;
        y = y == NULL ? this->head : y->next;
    }
...
int main(int argc, char const *argv[])
{
    ...
    Node *res = list1.OptimalApproach2(list2);
